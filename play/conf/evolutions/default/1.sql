...
CREATE TABLE post (
    ...
    CONSTRAINT `group__post_fk`FOREIGN KEY (`group_id`) REFERENCES `group`(`group_id`),
    PRIMARY KEY (post_id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE user_to_group (
    ...
    group_id INT NOT NULL,
    time BIGINT NOT NULL,
    CONSTRAINT `user__user_to_group_fk` FOREIGN KEY (`user_id`) REFERENCES user(`user_id`),
    CONSTRAINT `group__user_to_group_fk` FOREIGN KEY (`group_id`) REFERENCES `group`(`group_id`),
    PRIMARY KEY (id)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
